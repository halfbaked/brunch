(function() {
  ...
  exports.spawnStylus = function() {
    ...
    executeStylus = spawn('stylus', ['--compress', '--out', path.join(exports.options.buildPath, 'web/css'), path.join(exports.options.brunchPath, 'src/app/styles/main.styl'), path.join(exports.options.brunchPath, 'src/vendor/styles/')]);
